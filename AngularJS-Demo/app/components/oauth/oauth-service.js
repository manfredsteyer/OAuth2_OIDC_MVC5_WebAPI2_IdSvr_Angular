...
(function (namespace) {
    ...
    function OAuthService($document, $window, $timeout, $q, $location, $http, $log, $rootScope, $state) {
        ...
        this.setup = function (options) {
            ...
            if (this.getIsLoggedIn() || this.tryLogin()) {
                if (options.onTokenReceived) options.onTokenReceived();
